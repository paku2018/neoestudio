...
//
			$version3DSecure = "";
			if ($emv != null && array_key_exists(RESTConstants::$RESPONSE_MERCHANT_EMV3DS_PROTOCOLVERSION, $emv))
			...
			if (strcmp(RESTConstants::$RESPONSE_MERCHANT_EMV3DS_PROTOCOLVERSION_102, $version3DSecure) == 0) {
				...
				echo "ProtocolVersion 1.0.2";
			}else if (strcmp(RESTConstants::$RESPONSE_MERCHANT_EMV3DS_PROTOCOLVERSION_210, $version3DSecure) == 0) {
				echo "ProtocolVersion 2.1.0";
			} else if (strcmp(RESTConstants::$RESPONSE_MERCHANT_EMV3DS_PROTOCOLVERSION_220, $version3DSecure) == 0) {
				echo "ProtocolVersion 2.2.0";
			}
		...
		public function getMDParameter() {
			$md = "";
			$emv = $this->getOperation()->getEmv() != null ? json_decode($this->getOperation()->getEmv(), true) : null;
			if ($emv != null && array_key_exists(RESTConstants::$RESPONSE_MERCHANT_EMV3DS_MD, $emv))
		...
		public function getAcsURLParameter() {
			$acsURL = "";
			$emv = $this->getOperation()->getEmv() != null ? json_decode($this->getOperation()->getEmv(), true) : null;
			if($emv != null && array_key_exists(RESTConstants::$RESPONSE_MERCHANT_EMV3DS_ACSURL, $emv))
		...
		public function getPAReqParameter() {
			$PAReq = "";
			$emv = $this->getOperation()->getEmv() != null ? json_decode($this->getOperation()->getEmv(), true) : null;
			if($emv != null && array_key_exists(RESTConstants::$RESPONSE_MERCHANT_EMV3DS_PAREQ, $emv))
		...
		public function getThreeDSServerTransID() {
			...
			$emv = $this->getOperation()->getEmv() != null ? json_decode($this->getOperation()->getEmv(), true) : null;
			if($emv != null && array_key_exists(RESTConstants::$RESPONSE_MERCHANT_EMV3DS_THREEDSSERVERTRANSID, $emv));
		...
		public function getThreeDSInfo() {
			$threeDSInfo = "";
			$emv = $this->getOperation()->getEmv() != null ? json_decode($this->getOperation()->getEmv(), true) : null;
			if($emv != null && array_key_exists(RESTConstants::$RESPONSE_MERCHANT_EMV3DS_THREEDSINFO, $emv));
		...
		public function getThreeDSMethodURL() {
			$threeDSMethod = "";
			$emv = $this->getOperation()->getEmv() != null ? json_decode($this->getOperation()->getEmv(), true) : null;
			if($emv != null && array_key_exists(RESTConstants::$RESPONSE_MERCHANT_EMV3DS_THREEDSMETHODURL, $emv));
		...
		public function getCreqParameter() {
			$creq = "";
			$emv = $this->getOperation()->getEmv() != null ? json_decode($this->getOperation()->getEmv(), true) : null;
			if($emv != null && array_key_exists(RESTConstants::$RESPONSE_MERCHANT_EMV3DS_CREQ, $emv))
