...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">@lang('lng.Edit Exams')</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{url('home')}}">@lang('lng.Home')</a></li>
              <li class="breadcrumb-item active"><a href="{{url('insideExamsFoldersEdit'.$exam->id)}}">@lang('lng.Edit Exams')</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="row">
        <div class="col-12">
          <form method="POST" action="{{url('insideExamsFoldersUpdate/'.$exam->id)}}">
            {{ csrf_field() }}
                <div class="card-body container" style="width: 50%">
                  <div class="form-group">
                    <label for="name">@lang('lng.Name')</label>
                    <input type="text" class="form-control" name="name"  placeholder="@if(!empty($exam)){{$exam->name}}@endif" value="@if(!empty($exam)){{$exam->name}}@endif" required>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="scheduleDate" value="@if(!empty($exam)){{$exam->scheduleDate}}@endif"  placeholder="Enter schedule date here" required>
                  </div>
                  <!--
                  <div class="form-group">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input class="form-control" type="number" name="timeFrom" value="@if(!empty($exam)){{$exam->timeFrom/60}}@endif">
                  </div>
