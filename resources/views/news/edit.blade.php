    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">@lang('lng.Edit News')</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{url('home')}}">@lang('lng.Home')</a></li>
                            <li class="breadcrumb-item active">
                                <a href="{{url('news/edit/'.$news->id)}}">@lang('lng.Edit News')</a></li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <form method="POST" action="{{url('news/update/'.$news->id)}}">
                        ...
                        <div class="card-body container" style="width: 50%">
                            <div class="form-group">
                                ...
                                <textarea id="in" name="news">@if(!empty($news)){{$news->news2}}@endif</textarea>
                            </div>
                            <div class="form-group">
                                <label>@lang('lng.Student Type')</label>
                                <select class="form-control" name="studentType">
                                    <option value="Prueba" {{ ($news->studentType=="Prueba") ? 'selected="selected"' : '' }}>
                                        Prueba
                                    </option>
                                    <option value="Alumno" {{ ($news->studentType=="Alumno") ? 'selected="selected"' : '' }}>
                                        Alumno
                                    </option>
                                    <option value="Alumno Convocado" {{ ($news->studentType=="Alumno Convocado") ? 'selected="selected"' : '' }}>
                                        Alumno Convocado
                                    </option>
                                </select>
                            </div>
