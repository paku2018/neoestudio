  ...
  .forSm{
   ...
   <body>
    ...
    <!--<br><br><br>-->
      ...
      <br>
    <h4 class="mainHeading"><b>¿Por qué Neoestudio es tu academia online?</b></h4><br>
    ...
    <p class="content">
      ...
      <ul class="mU">
        <li class="liU">Con un <b>ranking masivo</b> en tiempo real desarrollado en la única aplicación nativa específica para la oposición de ingreso a la Guardia Civil.</li>
        <li class="liU">Con <b>réplicas de oposición</b> que aplican la puntuación del <b>baremo</b> y la fómula de psicotécnicos (<b>Campana de Gauss</b>).</li>
        <li class="liU">Con más de 1000 <b>imágenes</b> y <b>esquemas</b> de <b>alta calidad</b>.</li>
        <li class="liU">Con un <b>temario sintetizado</b> con todas las <b>palabras clave marcadas</b> por jerarquía de importancia.</li>
        <li class="liU">Con un <b>libro guia explicativo</b> desarrollado con ejemplos prácticos y exámenes oficiales de años anteriores, ejercicios, definiciones, etc.</li>
        <li class="liU">Con un <b>audiolibro profesional</b>.</li>
        <li class="liU">Con un sistema de <b>ranking por objetivos</b> que miden el rendimiento y aumentan la competitividad con tus compañeros.</li>
        <li class="liU">Formada por un atento <b>equipo de suboficiales</b> de la Guardia Civil.</li>
        <li class="liU">Con una amplia cola de <b>proyectos innovadores</b> que aplican las <b>técnicas de estudio más eficaces</b>.</li>
      </ul>
    </p>
    </div>
