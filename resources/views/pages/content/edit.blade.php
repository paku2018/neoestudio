...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <div class="col-12">
                    <form method="POST" action="{{url('pages/update/'.$content->id)}}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="card-body container" style="width: 50%">
                            <div class="form-group">
                                ...
                                <input type="text" id="title" name="title" class="form-control" value="{{ $content->title }}" placeholder="Sección de título"/>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="in" name="description">{{ $content->description }}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="name">Pedido de sección <span style="font-size: 14px;color: #ff0000;">(Escriba solo un número)</span></label>
                                <input type="number" id="order" name="order" class="form-control" min="0" value="{{ $content->order }}" placeholder="Pedido de sección"/>
                            </div>
