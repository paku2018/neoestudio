...
@section('content')
    ...
    <div class="content-wrapper">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">
                                <a href="{{url('materials/edit/'.$material->id)}}">@lang('lng.Edit Materials')</a></li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            <div class="row">
                <div class="col-12">
                    <form method="POST" action="{{url('pages/updateVideo/'.$video->id)}}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="card-body container" style="width: 50%">
                            ...
                            <div class="form-inline">
                                <input type="checkbox" class="form-control" name="check"><label>@lang('lng.Use This')
                                    &nbsp;
                                    &nbsp;</label><a href="{{url('materialDownload/'.$material->id)}}" class="btn btn-success btn-sm">@lang('lng.Download')</a>
                            </div>
                            <br>
                            <p>@lang('lng.OR')</p><br>
                            <div class="form-group">
