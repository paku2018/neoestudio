...
<head>
    ...
    <title>Payment | Books | Neoestudio</title>
    <style type="text/css">
        @font-face {
...
<br>
<div class="text-center"><h2 style="font-family: Proxima Nova Soft">Temario</h2></div>
<br>
...
<div class="container text-center">
    ...
    @if(!empty($price))
        <p>Precio&nbsp;&nbsp;:&nbsp;&nbsp;{{$price}}</p>
        <a class="btn btn-primary" href="{{url('pay/'.$userId.'/'.$price.'/'.'books'.'/'.'nul')}}">Enviar</a>
    @endif
</div>
