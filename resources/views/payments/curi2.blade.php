        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="{{url('pays/alumnoConvocado')}}">@lang('lng.Payments')</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                ...
                @if(!empty($pays))
                  ...
                  <?php
                    ...
                    <tr>
                      ...
                      <td>{{$count}}</td>
                      <td><a href="{{url('showAll/'.$type.'/'.$pay->userId)}}">View All</a></td>
...
<script type="text/javascript">
  ...
  $("#priAc").css('background-color','#6c757d');
