    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">@lang('lng.Update Product')</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <form method="POST" action="{{url('products/update/'.$product->id)}}" enctype="multipart/form-data">
                        ...
                        <div class="card-body container" style="width: 50%">
                            <div class="form-group">
                                ...
                                <input type="text" id="name" name="name" class="form-control" value="{{ $product->name }}" placeholder="@lang('lng.Name')" required/>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="in" name="description">{{$product->description}}</textarea>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" id="price" name="price" class="form-control" value="{{ (fmod($product->price, 1) !== 0.00) ? $product->price : round($product->price) }}" placeholder="@lang('lng.Price')" required/>
                            </div>
                            <div class="form-group">
                                <label for="order">@lang('lng.Product') <span style="font-size: 14px;color: #ff0000;">(Escriba solo un número)</span></label>
                                <input type="number" id="order" name="order" class="form-control" min="0" value="{{ $product->order }}" placeholder="Pedido de sección"/>
                            </div>
