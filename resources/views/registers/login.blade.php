        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto" id="horizontal-style">
                ...
                <li style="font-size: larger;">
                    <a href="" style="color:white;text-decoration:underline;text-underline-position:under;">Iniciar
                        sesión</a></li>
...
<br>
<div class="text-center"><h2 style="font-family: Proxima Nova Bold">Iniciar sesión</h2></div>
<br>
...
<div class="container forLg" style="width: 50%">
    ...
    <form method="post" action="{{url('submitLoginInfo')}}">
            ...
            <div class="col-md-6">
                <div style="width: 100%; border-radius: 20px; position: relative;">
                    ...
                    <input class="form-control" type="email" name="email" placeholder="Correo electrónico"
                           style="background:url('{{asset('neostudio/9.png')}}') ; background-size: 100% 100%; width: 100%; padding-left: 15%; height: 60px; font-size: 110%; box-shadow: none; border:none; padding-bottom: 14px;" required>
                </div>
            </div>
            <div class="col-md-6">
                <div style="width: 100%; border-radius: 20px; position: relative;">
        ...
        <div class="text-center">
            <input type="image" alt="Submit" src="{{asset('neostudio/entr.png')}}" style="width: 40%; text-align: center;"><br>
            <p><!--Regístrate-->
                <a href="{{url('registerate/'.$reason)}}" style="color: blue;"><img src="{{asset('neostudio/registerB.png')}}" style="width: 27%; text-align: center;"></a>
            </p>
        </div>
    </form>
</div>
...
<div class="container forSm" style="width: 100%;">
    ...
    <form method="post" action="{{url('submitLoginInfo')}}">
        ...
        <div class="row">
            <div class="col-12">
                <div style="width: 100%; border-radius: 20px; position: relative;">
                    ...
                    <input class="form-control" type="email" name="email" placeholder="Correo electrónico" style="background:url('{{asset('neostudio/9.png')}}');background-size: 100% 100%; width: 100%;padding-left: 16%; height: 55px; font-size: 120%; box-shadow: none;border:none;padding-bottom: 14px;" required>
                </div>
            </div>
        </div>
        <br>
        ...
        <div class="text-center">
            <input type="image" alt="Submit" src="{{asset('neostudio/entr.png')}}" style="width: 80%; text-align: center;"><br>
            <p><!--Regístrate-->
                <a href="{{url('registerate/'.$reason)}}"><img src="{{asset('neostudio/registerB.png')}}" style="width: 52%; text-align: center;"></a>
            </p>
        </div>
    </form>
</div>
