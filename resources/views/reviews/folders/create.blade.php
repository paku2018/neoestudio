...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"> ({{$studentType}}) Repaso @lang('lng.Create Folders')</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{url('home')}}">@lang('lng.Home')</a></li>
              <li class="breadcrumb-item active"><a href="{{url('reviewsFoldersCreate/'.$studentType)}}">@lang('lng.Create Folders')</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="row">
        <div class="col-12">
          <form method="POST" action="{{url('reviewsFoldersStore')}}">
            {{ csrf_field() }}
                <div class="card-body container" style="width: 50%">
                  ...
                  <input type="hidden" name="option" value="reviews">
